...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlane() {
        ...
        List<MilitaryPlane> transportMilitaryPlane = airport.getTransportMilitaryPlane();
        boolean flag = transportMilitaryPlane.stream().anyMatch(militaryPlane -> militaryPlane.getTypeOfMilitaryPlane() == MilitaryType.TRANSPORT);
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        bomberMilitaryPlanes.stream().filter(militaryPlane -> militaryPlane.getTypeOfMilitaryPlane() != MilitaryType.BOMBER).map(militaryPlane -> "Test failed!").forEach(Assert::fail);
    }
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        ...
        boolean hasUnclassifiedPlanes = ExperimentalPlanes.stream().anyMatch(experimentalPlane -> experimentalPlane.getClassificationLevel() == ClassificationLevel.UNCLASSIFIED);
